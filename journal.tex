...
\affiliation[arthur,sonia,lylia]{organization={ETIS UMR 8051,
CY Cergy Paris Université, ENSEA,},%Department and Organization
            addressline={},
            city={Cergy},
            postcode={95000},
            state={},
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\linewidth]{figs/NOTE_architecture.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{figs/T-NOTE_architecture.png}
